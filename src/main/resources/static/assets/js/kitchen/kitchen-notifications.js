document.addEventListener("DOMContentLoaded", () => {
  ...
  // Kitchen chỉ xem: ORDER_SENT_TO_KITCHEN, NEW_RESERVATION, SYSTEM
  const KITCHEN_TYPES = ["ORDER_SENT_TO_KITCHEN", "NEW_RESERVATION", "SYSTEM"];
  ...
  if (currentUserId) {
    ...
    source.addEventListener("DINIO_NOTIFY", (event) => {
      ...
      if (!KITCHEN_TYPES.includes(n.type)) return;
